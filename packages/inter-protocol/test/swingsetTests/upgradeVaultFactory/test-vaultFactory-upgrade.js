...
import { vfV1BundleName } from './bootstrap-vaultFactory-upgrade.js';

// so paths can be expresssed relative to this file and made absolute
const bfile = name => new URL(name, import.meta.url).pathname;

test('vaultFactory service upgrade', async t => {
  /** @type {SwingSetConfig} */
  const config = {
    ...
    vats: {
      bootstrap: {
        ...
        sourceSpec: bfile('bootstrap-vaultFactory-upgrade.js'),
      },
      zoe: {
